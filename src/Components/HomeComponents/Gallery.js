       ...
       <section className="grid_gallery_area">
        <div className="container">
          <div className="left_tittle">
            <h2>Gallery</h2>
            <p className="bold">They can turn into your instructor, your helper, your mentor</p>
          </div>
            ...
            <div className="row grid_gallery_item_inner imageGallery1">
              <div className="col-lg-4 col-md-6 activites restaurant">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage1}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 rooms interior">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage2}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 activites restaurant">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage3}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 rooms event restaurant">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage4}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 activites interior">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage5}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 rooms event restaurant">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage6}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 rooms event restaurant">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage7}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 activites interior">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage8}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 rooms event restaurant">
                <div className="grid_gallery_item">
                  ...
                  <div className="resort_g_hover"> 
                    <a className="light" href={galleryImage9}><i className="icon icon-Search" /></a> 
                  </div>
                </div>
              </div>
            </div>
